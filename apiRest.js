...
const find = require('./find'); // se enlaza en las operaciones metodos para ejecutar 
const save = require('./saveAndUpdate'); //operaciones save
const remove = require('./remove'); //del archivo de eliminar pelicula
var app = express();
